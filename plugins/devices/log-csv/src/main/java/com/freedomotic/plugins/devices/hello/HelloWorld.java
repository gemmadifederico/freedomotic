...
//            f.createNewFile();
            ...
            if (!f.isFile()) {
                f.createNewFile();
            	header = ("eventName,time,eventType,subjectName,objectAction,objectBehavior,objectLocationX,objectLocationY,triggerName,triggerAction,zoneName,temperature,luminosity,powered,openness,zoneDescription,zoneType,personId");            
            }
    ...
    protected void onEvent(EventTemplate event) {
        ...
        if (event instanceof ObjectHasChangedBehavior) {
            ...
            while (it.hasNext()) {
                ...
                if (triggerStatement.getAttribute().equals("object.action")) {
                    p.setObjectAction(triggerStatement.getValue());
                }
                ...
                if (triggerStatement.getAttribute().equals("object.behavior.temperature")) {
                    p.setTemperature(triggerStatement.getValue());
                }
                ...
                if (triggerStatement.getAttribute().equals("object.location.x")) {
                    p.setObjectLocationX(triggerStatement.getValue());
                }
                if (triggerStatement.getAttribute().equals("object.location.y")) {
                    p.setObjectLocationY(triggerStatement.getValue());
                }
            }
            ...
            while (it.hasNext()) {
                ...
                if (triggerStatement.getAttribute().equals("zone")) {
                    p.setZoneName(triggerStatement.getValue());
                }
            ...
            // zone.name, zone.description, zone.uuid, zone.type
            while (it.hasNext()) {
                Statement triggerStatement = it.next();
                if (triggerStatement.getAttribute().equals("zone.name")) {
                    p.setZoneName(triggerStatement.getValue());
                }
                if (triggerStatement.getAttribute().equals("zone.description")) {
                    p.setZoneDescription(triggerStatement.getValue());
                }
                if (triggerStatement.getAttribute().equals("zone.type")) {
                    p.setZoneType(triggerStatement.getValue());
                }
            }
            ...
            while (it.hasNext()) {
                ...
                if (triggerStatement.getAttribute().equals("person.id")) {
                    p.setPersonId(triggerStatement.getValue());
                }
                if (triggerStatement.getAttribute().equals("zone.name")) {
                    p.setZoneName(triggerStatement.getValue());
                }
